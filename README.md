...
1. Go to the [GitHub repository page](https://github.com/unc-cs-sg/github-tutorial) for this tutorial (if you're already here just scroll up). In the top right corner of the page, click **Fork**.
...
1. Open your command line and use `cd` to navigate to the folder where you want to download the project (eg. `Documents`). Type `git clone GIT_REPO_LINK` but replace `GIT_REPO_LINK` with the link you copied. This will download the project from GitHub onto your computer.
    - Eg. For my fork, I would run `cd /c/Users/AustinWang/Documents` and then run `git clone https://github.com/Dafondo/github-tutorial.git`
1. You will now have a folder named `github-tutorial` at your current location. Use `ls` to see it and use `cd github-tutorial` to move into the folder. This folder is your local Git repository.
...
1. Open the `README.md` file in the `github-tutorial` folder with any text editor.
...
1. Make sure these values match
    - `base repository`: `unc-cs-sg/github-tutorial` 
    - `base`: `master`
